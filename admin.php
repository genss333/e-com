                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-list" viewBox="0 0 16 16" style="color:orangered;margin-left:20px;"> 
                    ...
                    <div class="" id="">
                        ...
                        <a href="index.php"><img src="/img/logo.png" width="100%;" style="margin-top:50px;"></a>
                            <a type="button" class="btn btn-primary" href="admin.php" style="margin-top:35px; background:none; border:none; color:#555;">
                                    ...
                                    <br>
                                        <div class="text" style="margin-left:5%;">
                                            <h4>
                                                ...
                                                Product/สินค้าที่โฆษณา
                                            </h4>
                                        </div>
                                            <table class="tbl-cart" cellpadding="10" cellspacing="1"  style="margin-left:10%;">
                                            <br>
                                                <tbody>
                                                <tr>
                                                ...
                                                <th style="text-align:center;"width="20%">โปรโมท</th>
                                                <th style="text-align:left;"width="20%">รายได้จาการโปรโมท</th>
                                                </tr>
                                            <?php 
                                                $product = $db_handle->runQuery("SELECT product_promoted.id,product_promoted.product_id,product_promoted.count_date,product_promoted.slip,product_promoted.price,product.name,product.image,product.status,product.number 
                                                FROM product_promoted 
                                                INNER JOIN product ON product_promoted.product_id=product.product_id
                                                WHERE product.status='promoted'");
                                                    if(!empty($product)){
                                                        foreach($product as $key => $value){
                                                            ...
                                                            ?>
                                                                ...
                                                                <td style="text-align:center;"><?php  echo $product[$key]["count_date"]." วัน" ?></td>
                                                                <td style="text-align:left;"><?php echo number_format($product[$key]["price"])  ?></td>
                                            <?php
                                                                }
                                                            }
                                            ?>
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-basket" viewBox="0 0 16 16">
                                                        <path d="M5.757 1.071a.5.5 0 0 1 .172.686L3.383 6h9.234L10.07 1.757a.5.5 0 1 1 .858-.514L13.783 6H15a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1v4.5a2.5 2.5 0 0 1-2.5 2.5h-9A2.5 2.5 0 0 1 1 13.5V9a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h1.217L5.07 1.243a.5.5 0 0 1 .686-.172zM2 9v4.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V9H2zM1 7v1h14V7H1zm3 3a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-1 0v-3A.5.5 0 0 1 4 10zm2 0a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-1 0v-3A.5.5 0 0 1 6 10zm2 0a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-1 0v-3A.5.5 0 0 1 8 10zm2 0a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-1 0v-3a.5.5 0 0 1 .5-.5zm2 0a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-1 0v-3a.5.5 0 0 1 .5-.5z"/>
                                                         ...
                                                         <h5  style="margin-top: 10px;">รายการสินค้าทั้งหมด</h5> 
                                                           <?php 
                                                                $product = $db_handle->runQuery("SELECT count(*)number FROM product");
                                                                if(!empty($product)){
                                                                    foreach($product as $key => $value){
                                                                        echo $product[$key]["number"]."  รายการ";
                                                                    }
                                                                }
                                                           ?>
                                                    </div>
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-box-seam" viewBox="0 0 16 16">
                                                        <path d="M8.186 1.113a.5.5 0 0 0-.372 0L1.846 3.5l2.404.961L10.404 2l-2.218-.887zm3.564 1.426L5.596 5 8 5.961 14.154 3.5l-2.404-.961zm3.25 1.7-6.5 2.6v7.922l6.5-2.6V4.24zM7.5 14.762V6.838L1 4.239v7.923l6.5 2.6zM7.443.184a1.5 1.5 0 0 1 1.114 0l7.129 2.852A.5.5 0 0 1 16 3.5v8.662a1 1 0 0 1-.629.928l-7.185 2.874a.5.5 0 0 1-.372 0L.63 13.09a1 1 0 0 1-.63-.928V3.5a.5.5 0 0 1 .314-.464L7.443.184z"/>
                                                         ...
                                                         <h5  style="margin-top: 10px;">จำนวนสินค้าในคลัง</h5> 
                                                           <?php 
                                                                $product = $db_handle->runQuery("SELECT SUM(number) number FROM product");
                                                                if(!empty($product)){
                                                                    foreach($product as $key => $value){
                                            ...
                                            <div style=" background:white; " ><br>
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-check2-square" viewBox="0 0 16 16">
                                                        ...
                                                        <path d="m8.354 10.354 7-7a.5.5 0 0 0-.708-.708L8 9.293 5.354 6.646a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0z"/>
                                                         ...
                                                         <h5  style="margin-top: 10px;">โปรโมทแล้ว</h5> 
                                                           <?php 
                                                                $cart = $db_handle->runQuery("SELECT COUNT(*) product_id FROM product WHERE status='promoted'");
                                                                if(!empty($cart)){
                                                                    foreach($cart as $key => $value){
                                                                        echo $cart[$key]["product_id"]."  ชิ้น";
                                                                    }
                                                                }
                                                           ?>
                                                    </div>
                                                    ...
                                                    <div class="text" style="margin-left:15%;">
                                                      <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-coin" viewBox="0 0 16 16">
                                                         ...
                                                         <h5  style="margin-top: 10px;">รายได้รวมสุทธิ</h5> 
                                                           <?php 
                                                                $cart = $db_handle->runQuery("SELECT SUM(product_promoted.price) income,product.status 
                                                                FROM product_promoted 
                                                                INNER JOIN product ON product_promoted.product_id=product.product_id 
                                                                WHERE product.status='promoted'");
                                                                if(!empty($cart)){
